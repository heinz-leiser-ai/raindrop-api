...
| RDBE-4  | Raindrops CRUD              | P0       | In Review | `v1/raindrops/*`, `src/data/sagas/bookmarks/*`                       | Bookmarks verwalten inkl. Single/Batch-Flows          |
| RDBE-5  | Tags                        | P0       | QA Passed | `v1/tags.md`, `src/data/sagas/tags/*`                                | Tags laden, umbenennen, loeschen                      |
| RDBE-6  | Suche & Filter              | P0       | QA Passed | `v1/filters.md`, `src/data/sagas/filters.js`                         | Suche, Sortierung, Pagination, Filterdaten            |
| RDBE-7  | File Upload (Storage)       | P0       | In Review | `v1/raindrops/single.md`, `v1/collections/covers-icons.md`           | Upload von Dateien und Covern ueber Storage           |
| RDBE-8  | Import / Export             | P1       | In Review | `v1/import.md`, `v1/export.md`, `src/data/sagas/import.js`           | Daten importieren/exportieren fuer Migration          |
